...
## 📡 项目动态 (Project Roadmap)
| 形态 | 分支 | 状态 | 核心能力 |
| :--- | :--- | :--- | :--- |
| 🐚 **CLI 命令行** | [`main-cmd`](https://github.com/AiToByte/safemask/tree/main-cmd) | **稳定版 (Stable)** | 高性能文件脱敏、混合引擎、保序流水线 |
| 🖥️ **Desktop 桌面** | `main` | **基本完成，持续优化** | **Tauri 驱动**、剪贴板实时监听、静默脱敏、可视化配置 |


> **📢 立即开始使用：**
> 如果您需要处理本地大规模日志，或手动清洗剪贴板内容，请点击切换至 **[`main-cmd`](https://github.com/AiToByte/safemask/tree/main-cmd)** 分支。


> **🧪 实验性特性预告：**
> `main` 分支正在进行 **SafeMask Desktop** 的封闭开发。我们利用 **Tauri + Rust** 的高性能架构，实现对系统剪贴板的“无感监控”——敏感信息在进入 AI 对话框前将被自动拦截并替换。敬请期待！
